...
public class BlackBondFutureOptionMarginedTradePricerTest {
  ...
  private static final ZoneId ZONE = OPTION_PRODUCT.getExpirationZone();
  ...
  public void test_presentValueSensitivity() {
    ...
    double expirationTime = ACT_365F.relativeYearFraction(VALUATION_DATE, OPTION_PRODUCT.getExpirationDate());
