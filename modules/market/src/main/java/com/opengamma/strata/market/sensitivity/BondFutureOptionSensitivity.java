...
public final class BondFutureOptionSensitivity
  ...
  public static BondFutureOptionSensitivity of(
    ...
    return new BondFutureOptionSensitivity(
        futureSecurityId, expirationDate, futureExpiryDate, strikePrice, futurePrice, sensitivityCurrency, sensitivity);
  }
  ...
  public BondFutureOptionSensitivity withCurrency(Currency currency) {
    ...
    return new BondFutureOptionSensitivity(
        futureSecurityId, expiration, futureExpiryDate, strikePrice, futurePrice, currency, sensitivity);
  }
  ...
  public BondFutureOptionSensitivity multipliedBy(double factor) {
    return new BondFutureOptionSensitivity(
        futureSecurityId, expiration, futureExpiryDate, strikePrice, futurePrice, currency, sensitivity * factor);
  }

  @Override
  public BondFutureOptionSensitivity mapSensitivity(DoubleUnaryOperator operator) {
    return new BondFutureOptionSensitivity(
        futureSecurityId, expiration, futureExpiryDate, strikePrice, futurePrice, currency,
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getFutureSecurityId(), other.getFutureSecurityId()) &&
          JodaBeanUtils.equal(getExpiration(), other.getExpiration()) &&
          JodaBeanUtils.equal(getFutureExpiryDate(), other.getFutureExpiryDate()) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(getFutureExpiryDate());
  ...
  public String toString() {
    ...
    buf.append("futureExpiryDate").append('=').append(getFutureExpiryDate()).append(',').append(' ');
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ZonedDateTime> expiration = DirectMetaProperty.ofImmutable(
        this, "expiration", BondFutureOptionSensitivity.class, ZonedDateTime.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -837465425:  // expiration
          return ((BondFutureOptionSensitivity) bean).getExpiration();
        case -1119821404:  // futureExpiryDate
