...
public final class FixedIborSwapTemplate
   ...
   * @return the trade
   */
  public SwapTrade toTrade(LocalDate tradeDate, BuySell buySell, double notional, double fixedRate) {
    return convention.toTrade(tradeDate, periodToStart, tenor, buySell, notional, fixedRate);
  }
